...
**Status:** Accepted **Date:** 2025-10-29 **Deciders:** Development Team **Tags:**
architecture, api, backend, versioning

## Context

The FitFolio API needed a versioning strategy to support backward compatibility as
features evolve. We needed to choose between several approaches:
...
Use directory-based versioning with the structure `app/api/v1/` and URL prefix
`/api/v1/`.
