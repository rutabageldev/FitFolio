...
down_revision: str | Sequence[str] | None = "27175cb3061e"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_users_email_ci", "users", [sa.literal_column("lower(email)")], unique=True
    )
    op.create_table(
        "login_events",
    ...
    op.create_index(
        "ix_login_events_event_type_created_at",
        "login_events",
