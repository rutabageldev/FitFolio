# Test plan migrated: Admin

Admin test planning has moved to:

- Domain doc: `docs/testing/domains/admin.md`
- Catalog: `docs/testing/catalog/admin.yaml`

Implement tests under `backend/tests/admin/**` and contract checks under `backend/tests/contract/**`.
