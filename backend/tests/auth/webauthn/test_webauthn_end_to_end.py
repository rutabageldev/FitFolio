"""End-to-end WebAuthn tests using real manager and Redis.

Scope:
- Exercises real WebAuthn manager and Redis-backed challenge storage
- Verifies DB writes and cookie/session behavior
- Only unavoidable browser credential response is mocked
"""
